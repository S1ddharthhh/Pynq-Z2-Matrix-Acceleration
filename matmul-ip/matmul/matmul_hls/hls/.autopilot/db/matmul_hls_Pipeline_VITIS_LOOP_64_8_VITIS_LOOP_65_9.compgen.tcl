...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler matmul_hls_sparsemux_33_4_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename C \
    op interface \
    ports { C_address0 { O 10 vector } C_ce0 { O 1 bit } C_q0 { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TREADY { I 1 bit } stream_out_TDATA { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_out_TVALID { O 1 bit } stream_out_TLAST { O 1 vector } } \
} "
} else {
