; ModuleID = '/home/siddharth/Project-Demo/matmul-ip/matmul/matmul_hls/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_matmul_hls_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %stream_in, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull dereferenceable(12) %stream_out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_matmul_hls_hw(i32* %stream_in_copy.data, i4* %stream_in_copy.keep, i4* %stream_in_copy.strb, i1* %stream_in_copy.last, i32* %stream_out_copy.data, i4* %stream_out_copy.keep, i4* %stream_out_copy.strb, i1* %stream_out_copy.last)
...
declare void @apatb_matmul_hls_hw(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*)
...
define void @matmul_hls_hw_stub_wrapper(i32*, i4*, i4*, i1*, i32*, i4*, i4*, i1*) #5 {
entry:
  ...
  call void @matmul_hls_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %8, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* %9)
...
declare void @matmul_hls_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_uint<32>, 0, 0, 0, '8', false>, 0>"* noalias nonnull)
